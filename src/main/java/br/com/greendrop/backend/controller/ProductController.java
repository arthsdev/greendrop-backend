...
public class ProductController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ProductDetailResponseDTO> getById(@PathVariable UUID id) {
    ...
    @GetMapping
    public ResponseEntity<PaginatedResponse<ProductListResponseDTO>> list(
    ...
    @GetMapping("/me")
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<PaginatedResponse<ProductListResponseDTO>> getMyProducts(
            @ParameterObject Pageable pageable
    ) {
    ...
    // MY CLAIMS
    // =============================================================
    @Operation(summary = "List claimed products")
    @GetMapping("/me/claims")
    @PreAuthorize("hasRole('COLLECTOR')")
    public ResponseEntity<PaginatedResponse<ProductListResponseDTO>> getMyClaimedProducts(
            @ParameterObject Pageable pageable
    ) {
    ...
    @PreAuthorize("hasRole('COLLECTOR')")
    public ResponseEntity<ProductDetailResponseDTO> claim(@PathVariable UUID id) {
    ...
    @PreAuthorize("hasRole('COLLECTOR')")
    public ResponseEntity<ProductDetailResponseDTO> unclaim(@PathVariable UUID id) {
